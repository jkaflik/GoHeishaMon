...
func onAquareaCommand(commandsChannel chan []byte) func(mclient mqtt.Client, msg mqtt.Message) {
	return func(mclient mqtt.Client, msg mqtt.Message) {
		topicPieces := strings.Split(msg.Topic(), "/")
